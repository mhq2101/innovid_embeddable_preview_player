...
WHERE
    meta.ActualEndDate >= '2018-08-20'
	AND meta.ActualStartDate <= '2018-08-20'
...
SELECT
  ...
  SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) AS Impressions,
  NVL(SUM(CASE WHEN split_part(s.EventValue,',',2) = 'ClickThru' THEN s.occurrences END),0) AS Clickthroughs,
  SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_25' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) AS "25%",
  SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_50' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) AS "50%",
  SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_75' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) AS "75%",
  SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_complete' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) AS "100%",
  CASE WHEN SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) = 0 THEN CONCAT(0.00,'%') ELSE CONCAT(NVL(ROUND(100 * SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_complete' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL/SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL,2),0.00), '%') END AS CompletionRate,
  CASE WHEN SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) = 0 THEN CONCAT(0.00,'%') ELSE CONCAT(ROUND(25 * (SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_25' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL
     + SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_50' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL 
     + SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_75' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL 
     + SUM(CASE WHEN split_part(s.EventValue,',',3) = 'video_playback_complete' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL)/SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL,2),'%') END AS PercentAdViewed,
  CASE WHEN SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END) = 0 THEN CONCAT(0.00,'%') ELSE CONCAT(NVL(ROUND(100 * SUM(CASE WHEN split_part(s.EventValue,',',2) = 'ClickThru' THEN s.occurrences END)::DECIMAL/SUM(CASE WHEN split_part(s.EventValue,',',3) = 'Video_Version' AND split_part(s.EventValue,',',2) = 'Progress' THEN s.occurrences END)::DECIMAL,2),0), '%') END AS CTR
FROM StatisticsDailySummary s
...
AND s.Date between '2018-08-09' and '2018-08-09'
