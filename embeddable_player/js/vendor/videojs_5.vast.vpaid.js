...
module.exports = function VASTPlugin(options) {
  ...
  logger.setVerbosity (settings.verbosity);
    ...
    //DISABLED THE FLASH ENTIRELY FROM THE PLAYER.
  ...
  function trackAdError(error, vastResponse) {
    ...
    // if(error.message = "VAST Error: on VASTClient.requestVastXML, HTTP request error with status '-1'") {
    //   document.querySelector('.vjs-video-container').innerHTML = 'The Ad Format you are attempting to play is not compatible with this player'
    //   alert('The Ad Format you are attempting to play is not compatible with this player');
    // }
