...
// Required children
  ...
  var MuteToggle = (function (_Button) {
    ...
    MuteToggle.prototype.handleClick = function handleClick() {
      console.log("this.player_.muted() MuteToggle: " ,this.player_.muted());
      console.log("this.player_ : ",this.player_);
      this.player_.cachedVol= this.player_.volume();
...
// Required children
  ...
  var VolumeBar = (function (_Slider) {
    ...
    VolumeBar.prototype.handleMouseMove = function handleMouseMove(event) {
      ...
      // this.player_.volume(this.player_.cachedVol);
      this.player_.volume(this.calculateDistance(event));
      console.log("this.player_.muted() VolumeBar: 1111",this.player_.muted());
    };
